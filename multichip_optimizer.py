...
def chip_load_summary(placement, topology):
    loads = defaultdict(int)
    for q, chip in placement.items():
        loads[chip] += 1
    print("Chip loads:", dict(loads))
    print("Capacities:", topology.qubits_per_chip)
...
class MultiChipPlacementOptimizer:
    ...
    def optimize(self, circuit: QuantumCircuit, routing_mode: str = "path", return_circuit_copy: bool = True) -> Dict:
